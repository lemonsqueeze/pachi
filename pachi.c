...
usage(char *arg)
{
	...
	fprintf(stderr,
		...
		"                                    experimental: katago handles first moves in each corner. \n"
		"                                    significantly stronger but possibly unbalanced as pachi \n"
		"                                    doesn't always have the strength to follow up. \n"
